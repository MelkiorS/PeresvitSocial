...
scheduler.showLightbox = function(id) {
	...
	if ( (pid || pid*1 === 0) && ev.rec_type) {
		// direct API call on series userId
...
scheduler.__recurring_template='<div class="dhx_form_repeat"> <form> <div class="dhx_repeat_left"> <label><input class="dhx_repeat_radio" type="radio" roleName="repeat" value="day" />Daily</label><br /> <label><input class="dhx_repeat_radio" type="radio" roleName="repeat" value="week"/>Weekly</label><br /> <label><input class="dhx_repeat_radio" type="radio" roleName="repeat" value="month" checked />Monthly</label><br /> <label><input class="dhx_repeat_radio" type="radio" roleName="repeat" value="year" />Yearly</label> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_center"> <div style="display:none;" userId="dhx_repeat_day"> <label><input class="dhx_repeat_radio" type="radio" roleName="day_type" value="d"/>Every</label><input class="dhx_repeat_text" type="text" roleName="day_count" value="1" />day<br /> <label><input class="dhx_repeat_radio" type="radio" roleName="day_type" checked value="w"/>Every workday</label> </div> <div style="display:none;" userId="dhx_repeat_week"> Repeat every<input class="dhx_repeat_text" type="text" roleName="week_count" value="1" />week next days:<br /> <table class="dhx_repeat_days"> <tr> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="1" />Monday</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="4" />Thursday</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="2" />Tuesday</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="5" />Friday</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="3" />Wednesday</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="6" />Saturday</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" roleName="week_day" value="0" />Sunday</label><br /><br /> </td> </tr> </table> </div> <div userId="dhx_repeat_month"> <label><input class="dhx_repeat_radio" type="radio" roleName="month_type" value="d"/>Repeat</label><input class="dhx_repeat_text" type="text" roleName="month_day" value="1" />day every<input class="dhx_repeat_text" type="text" roleName="month_count" value="1" />month<br /> <label><input class="dhx_repeat_radio" type="radio" roleName="month_type" checked value="w"/>On</label><input class="dhx_repeat_text" type="text" roleName="month_week2" value="1" /><select roleName="month_day2"><option value="1" selected >Monday<option value="2">Tuesday<option value="3">Wednesday<option value="4">Thursday<option value="5">Friday<option value="6">Saturday<option value="0">Sunday</select>every<input class="dhx_repeat_text" type="text" roleName="month_count2" value="1" />month<br /> </div> <div style="display:none;" userId="dhx_repeat_year"> <label><input class="dhx_repeat_radio" type="radio" roleName="year_type" value="d"/>Every</label><input class="dhx_repeat_text" type="text" roleName="year_day" value="1" />day<select roleName="year_month"><option value="0" selected >January<option value="1">February<option value="2">March<option value="3">April<option value="4">May<option value="5">June<option value="6">July<option value="7">August<option value="8">September<option value="9">October<option value="10">November<option value="11">December</select>month<br /> <label><input class="dhx_repeat_radio" type="radio" roleName="year_type" checked value="w"/>On</label><input class="dhx_repeat_text" type="text" roleName="year_week2" value="1" /><select roleName="year_day2"><option value="1" selected >Monday<option value="2">Tuesday<option value="3">Wednesday<option value="4">Thursday<option value="5">Friday<option value="6">Saturday<option value="7">Sunday</select>of<select roleName="year_month2"><option value="0" selected >January<option value="1">February<option value="2">March<option value="3">April<option value="4">May<option value="5">June<option value="6">July<option value="7">August<option value="8">September<option value="9">October<option value="10">November<option value="11">December</select><br /> </div> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_right"> <label><input class="dhx_repeat_radio" type="radio" roleName="end" checked/>No end date</label><br /> <label><input class="dhx_repeat_radio" type="radio" roleName="end" />After</label><input class="dhx_repeat_text" type="text" roleName="occurences_count" value="1" />occurrences<br /> <label><input class="dhx_repeat_radio" type="radio" roleName="end" />End by</label><input class="dhx_repeat_date" type="text" roleName="date_of_end" value="'+scheduler.config.repeat_date_of_end+'" /><br /> </div> </form> </div> <div style="clear:both"> </div>';
